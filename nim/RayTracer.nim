import chroma, math, times, pixie, vmath
...
proc main() =
  var
    scene = newScene()
    sceneImage = newImage(500, 500)
  let t1 = epochTime()
  renderScene(scene, sceneImage)
  let t = epochTime() - t1
  sceneImage.writeFile("nim-raytracer.png")
  echo "Completed in ", t, " sec"
